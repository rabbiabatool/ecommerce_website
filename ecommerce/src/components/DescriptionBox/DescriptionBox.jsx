    ...
    return (
        ...
        <div className="description_box">
            <div className="description_box_navigator">
                <div className="description_box_nav-box">Description</div>
                <div className="description_box_nav-box fade">Reviews (122)</div>
            </div>
            <div className="description_box_description">
                ...
                <p>E-commerce (electronic commerce) is the exchange of goods and services and the transmission of fund</p>
            </div>
